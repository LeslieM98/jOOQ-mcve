...
public class Army extends TableImpl<ArmyRecord> {
     ...
     */
    public final TableField<ArmyRecord, Integer> HQ = createField(DSL.name("HQ"),
            org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>ARMY.TROOP</code>.
     */
    public final TableField<ArmyRecord, Integer> TROOP = createField(DSL.name("TROOP"),
            org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CONSTRAINT_INDEX_1, Indexes.CONSTRAINT_INDEX_1E,
                Indexes.CONSTRAINT_INDEX_1EC, Indexes.PRIMARY_KEY_1);
    }
