...
public class TroopRecord extends UpdatableRecordImpl<TroopRecord> implements
        Record13<Integer, Integer, Integer, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double>,
        ITroop {
    ...
    @Override
    public TroopRecord values(Integer value1, Integer value2, Integer value3, Double value4, Double value5,
     ...
     */
    public TroopRecord(Integer id, Integer currentHealth, Integer maxHealth, Double posX, Double posY,
            Double normalSpeed, Double streetSpeed, Double difficultTerrainSpeed, Double closeCombatRange,
            Double rangedCombatRange, Double normalViewDistance, Double disadvantagedViewDistance,
