...
public class Troop implements ITroop {
    ...
    public Troop(Integer id, Integer currentHealth, Integer maxHealth, Double posX, Double posY, Double normalSpeed,
            Double streetSpeed, Double difficultTerrainSpeed, Double closeCombatRange, Double rangedCombatRange,
            Double normalViewDistance, Double disadvantagedViewDistance, Double advantagedViewDistance) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (o == null || !(o instanceof ITroop))
            return false;
        ITroop troop = (ITroop) o;
        return Objects.equals(getId(), troop.getId()) && Objects.equals(getCurrentHealth(), troop.getCurrentHealth())
                && Objects.equals(getMaxHealth(), troop.getMaxHealth()) && Objects.equals(getPosX(), troop.getPosX())
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getCurrentHealth(), getMaxHealth(), getPosX(), getPosY(), getNormalSpeed(),
                getStreetSpeed(), getDifficultTerrainSpeed(), getCloseCombatRange(), getRangedCombatRange(),
                getNormalViewDistance(), getDisadvantagedViewDistance(), getAdvantagedViewDistance());
    }
}
